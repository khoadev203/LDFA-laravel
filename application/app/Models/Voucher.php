...
{
    protected $fillable = ['user_id','voucher_amount','voucher_code','json_data','created_at','updated_at','currency_id','currency_symbol','user_loader','is_loaded','voucher_fee','wallet_id','voucher_value', 'metal_value'];
