            ...
            function n(t, e, i) {
                ...
                for (var r, n, s, o, a, h, l, u, c, p, f = i ? 0 : [], d = 0, g = t.length; d < g; d++) {
                    ...
                    if ("M" == x[0]) r = a = x[1], n = h = x[2];
                        ...
                        "C" == x[0] ? (r = (c = [r, n].concat(x.slice(1)))[6], n = c[7]) : (c = [r, n, r, n, a, h, a, h], r = a, n = h);
        ...
        r = [i(1)], void 0 === (n = function(S) {
            if (!S || S.svg) {
                ...
                var E = function(t, e) {
                    ...
                    I = function(t, e, i) {
                        if ("path" == t.type) {
                            ...
                            if ("open" == g ? (x += 2, v += 2, y += 2, s = 1, o = i ? 4 : 1, a = {
                                    fill: "none",
                                    stroke: p.stroke
                                }) : (o = s = x / 2, a = {
                                    fill: p.stroke,
                                ...
                                i ? (r = t._.arrows.startdx * f || 0, n = S.getTotalLength(p.path) - k * f) : (r = k * f, n = S.getTotalLength(p.path) - (t._.arrows.enddx * f || 0)), (a = {})["marker-" + u] = "url(#" + b + ")", (n || r) && (a.d = S.getSubpath(p.path, r, n)), E(c, a), t._.arrows[u + "Path"] = m, t._.arrows[u + "Marker"] = b, t._.arrows[u + "dx"] = k, t._.arrows[u + "Type"] = g, t._.arrows[u + "String"] = e
                            } else i ? (r = t._.arrows.startdx * f || 0, n = S.getTotalLength(p.path) - r) : (r = 0, n = S.getTotalLength(p.path) - (t._.arrows.enddx * f || 0)), t._.arrows[u + "Path"] && E(c, {
                ...
                (h.prototype = t).constructor = h, S._engine.path = function(t, e) {
                    ...
                    for (null == t ? (this._vbSize && (h = 1), delete this._vbSize, s = "0 0 " + this.width + " " + this.height) : (this._vbSize = h, s = t + " " + e + " " + i + " " + r), E(this.canvas, {
                            viewBox: s,
        ...
        return s(e, t), e.prototype.init = function() {
            ...
            return o = this.width / this.options.data.length, t = this.options.stacked ? 1 : this.options.ykeys.length, n = (o * this.options.barSizeRatio - this.options.barGap * (t - 1)) / t, this.options.barSize && (n = Math.min(n, this.options.barSize)), e = o - n * t - this.options.barGap * (t - 1), u = e / 2, x = this.ymin <= 0 && 0 <= this.ymax ? this.transY(0) : null, this.bars = function() {
                ...
                for (i = this.data, r = [], a = t = 0, e = i.length; t < e; a = ++t) c = i[a], h = 0, r.push(function() {
                    var t, e, i, r;
                    for (i = c._y, r = [], p = t = 0, e = i.length; t < e; p = ++t) null !== (g = i[p]) ? (x ? (d = Math.min(g, x), s = Math.max(g, x)) : (d = g, s = this.bottom), l = this.left + a * o + u, this.options.stacked || (l += p * (n + this.options.barGap)), f = s - d, this.options.verticalGridCondition && this.options.verticalGridCondition(c.x) && this.drawBar(this.left + a * o, this.top, o, Math.abs(this.top - this.bottom), this.options.verticalGridColor, this.options.verticalGridOpacity, this.options.barRadius), this.options.stacked && (d -= h), this.drawBar(l, d, n, f, this.colorFor(c, p, "bar"), this.options.barOpacity, this.options.barRadius), r.push(h += f)) : r.push(null);
                    return r
                }.call(this));
                return r
            }.call(this)
