                ...
                <div class="card">
                    ...
                    <div class="body">
                         {{csrf_field()}}
                          ...
                          <input type="hidden" name="first_currency_id" value="{{$firstCurrency->id}}">
                          <input type="hidden" name="second_currency_id" value="{{$secondCurrency->id}}">
                          <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="nav-item dropdown">
                                      ...
                                      <div class="dropdown-menu" aria-labelledby="CurrencyNavbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="{{url('/')}}/exchange/first/{{$firstCurrency->id}}/second/{{$currency->id}}"> 
                                        {{$currency->name}}
                                        </a>
                                        {{--@endif--}}
                                         @empty
