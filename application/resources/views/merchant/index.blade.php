        ...
        <div class="col-md-9 ">
          <div class="card">
            ...
            <div class="body">
              <div class="row">
                <div class="col">
                  <a href="{{route('merchant.new')}}" class="btn btn-primary float-right mb-4">{{__('Add Merchant')}}</a>
                </div>
              </div>
                  ...
                  <tbody>
                    @foreach( $merchants as $merchant)
                        <tr>
                          ...
                          <td><a href="{{url('/')}}/merchant/{{$merchant->id}}/docs" class="btn btn-primary btn-sm">{{__('Integration Guide')}}</a></td>
                        </tr>
                    @endforeach
                  </tbody>
                </table>
