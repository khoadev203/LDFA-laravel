...
<div class="row">
	   ...
	   <div class="col-md-9 " >
	   	<div class="card">
		    ...
		    <div class="body">
               <p><span class="text-primary">Merchant Key : </span>{{$merchant->merchant_key}} </p>
			   	<p><span class="text-primary">Merchant ID : </span>{{$merchant->id}}</p>
			   	<p><span class="text-primary">Merchant Currency Code : </span>{{$merchant->currency->code}}</p>
			   	<p><span class="text-primary">Merchant Currency Symbol : </span>{{$merchant->currency->symbol}}</p>
			   	<p><span class="text-primary">Merchant Request URL : </span>{{url('/')}}/purchase/link</p>
			   	<p><span class="text-primary">Merchant Transaction Status URL : </span>{{url('/')}}/request/status</p>
    ...
    <div class="body">
		...
		<h5><strong>Step 1:</strong></h5>
	   	<div class="alert alert-info mb-5">
	   		<p>Send a CURL POST request that contains <strong><small>(string) => </small>'merchant_key'</strong>, <strong><small>(array) => </small>'invoice'</strong>, and <strong><small>(string) => </small> 'currency_code'</strong> variables to  <kbd>{{url('/')}}/purchase/link</kbd>. As a response you get an array containing the link to the checkout page
	   		</p>
...
$invoice['total'] = 40.00;
$invoice['return_url'] = '{{$merchant->success_link}}';
$invoice['cancel_url'] = '{{$merchant->fail_link}}';
