        ...
        <div class="body">
            ...
            <div class="row mb-3">
              ...
              <div class="col-md-9 text-center">
                {!! QrCode::size(250)->generate($strQR); !!}
              </div>
            ...
            <div class="row">
              <div class="col-md-12 mb-3">
                ...
                <input type="text" class="form-control" id="referral_note" name="referral_note" placeholder="This will show up in the referral landing page" value="{{Auth::user()->referral_note}}">
              </div>
            </div>
