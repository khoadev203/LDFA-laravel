...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::group([
            ...
            Route::put('{id}', ['uses' => $namespacePrefix.'VoyagerUserController@update',       'as' => 'update']);
        });
        ...
        Route::group([
            ...
            Route::any('/', ['uses' => $namespacePrefix.'VoyagerLdbalanceController@index',        'as' => 'index']);
            Route::get('/history', ['uses' => $namespacePrefix.'VoyagerLdbalanceController@history',        'as' => 'history']);
        });
        // BuyCertificate
        Route::group([
            'as'     => 'BuyCertificate.',
            'prefix' => 'BuyCertificate',
        ], function () use ($namespacePrefix) {
            Route::any('/', ['uses' => $namespacePrefix.'VoyagerCertificateController@index',        'as' => 'index']);
        });
        
        Route::any('/redeem', ['uses' => $namespacePrefix.'VoyagerCertificateController@redeem',        'as' => 'redeem']);
        Route::any('/Transactions', ['uses' => $namespacePrefix.'VoyagerPendingTransactionController@index',        'as' => 'Transactions']);
