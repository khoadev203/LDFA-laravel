<?php
	...
	if(empty($_SESSION['UserId'])){
		echo "<script>location.href='AuthLogin'</script>";
	}
	include "vendor/auth/auth.config.php";
	$Auth = $_SESSION['UserId'];
	$GetUser = mysqli_query($ConClass, "SELECT * FROM `users` WHERE `id`='$Auth'");
	$GUD = mysqli_fetch_assoc($GetUser);
	$GetMerchant = mysqli_query($ConClass, "SELECT * FROM `merchants` WHERE `user_id`='$Auth'");
	$GM = mysqli_fetch_assoc($GetMerchant);
	$AuthMerchent = $GM['id'];
?>
<!doctype html>
<html lang="en">
...
<head>
    <meta charset="utf-8">
      ...
      <title>LDFA Marchents Dashboards</title>
      ...
      <div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="index.html" class="header-logo">
                  <img src="assets/images/logo.png" style="height: 56px;" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">Marchent Dashboard</h5>
              </a>
          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
					  ...
					  <li>
                          <a href="ActivationRequests" class="svg-icon">                        
                              <svg  class="svg-icon" id="p-dash1" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                  <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line>
                              </svg>
                              <span class="ml-4">Activation Request</span>
                          </a>
                      </li>
                      <li class=" ">
                          ...
                          <ul id="product" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="Application">
                                      <i class="fa fa-minus"></i><span>Applications</span>
                                  </a>
                              </li>
							  <li class="">
                                  <a href="ApiKeys">
                                      <i class="fa fa-minus"></i><span>API Key</span>
                                  </a>
                              </li>
                          </ul>
                      </li>
					  <li class=" ">
                          ...
                          <ul id="sales" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="Balance">
                                      <i class="fa fa-minus"></i><span>Balance</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="Sales">
                                      <i class="fa fa-minus"></i><span>Sales</span>
                                  </a>
                              </li>
                          </ul>
                      </li>
					  <li class=" ">
                          ...
                          <ul id="users" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="customers">
                                  <a href="Customers">
                                      <i class="fa fa-minus"></i><span>Customers</span>
                                  </a>
                              </li>
                          </ul>
                      </li>
              ...
              <nav class="navbar navbar-expand-lg navbar-light p-0">
                  <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                      ...
                      <a href="index.html" class="header-logo">
                          ...
                          <h5 class="logo-title ml-3">LDFA</h5>
                                  ...
                                  <div class="iq-sub-dropdown dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <div class="card shadow-none m-0">
                                          <div class="card-body p-0 text-center">
                                              ...
                                              <div class="p-3">
                                                  <h5 class="mb-1"><?php echo $GUD['name']; ?></h5>
